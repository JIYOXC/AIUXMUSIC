...
from AIUXMUSIC.utils.database import get_authuser_names, get_cmode
from AIUXMUSIC.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AIUXMUSIC.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await AIUXMUSIC.stop_stream(message.chat.id)
    except:
        pass
