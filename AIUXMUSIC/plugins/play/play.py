...
from AIUXMUSIC import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AIUXMUSIC.core.call import AIUXMUSIC
from AIUXMUSIC.utils import seconds_to_min, time_to_seconds
from AIUXMUSIC.utils.channelplay import get_channeplayCB
from AIUXMUSIC.utils.database import is_video_allowed
from AIUXMUSIC.utils.decorators.language import languageCB
from AIUXMUSIC.utils.decorators.play import PlayWrapper
from AIUXMUSIC.utils.formatters import formats
from AIUXMUSIC.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AIUXMUSIC.utils.inline.playlist import botplaylist_markup
from AIUXMUSIC.utils.logger import play_logs
from AIUXMUSIC.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await AIUXMUSIC.stream_call(url)
...
@app.on_callback_query(
    filters.regex("AIUXMUSICPlaylists") & ~BANNED_USERS
)
@languageCB
